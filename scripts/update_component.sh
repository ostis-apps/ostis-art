...
cp -Rfv $base_path/components/cpu_searching/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/cpu_searching/cpu_searching.js
